...
//             <div className="text-center mb-8">
//               <h2 className="text-xl font-bold mb-2">BONAFIDE CERTIFICATE</h2>
//               <p className="text-sm text-gray-600">Ref No: {previewData.refNumber || 'N/A'}</p>
//               <p className="text-sm text-gray-600">Date: {formatDate(previewData.issueDate)}</p>
//             </div>
...
//               {previewData.purpose && (
//                 <p>This certificate is issued for the purpose of: <span className="font-bold">{previewData.purpose}</span>.</p>
//               )}
